...
import { Breadcrumb, Button, Card, Col, Divider, Form, Input, InputRef, Row, Select, Space, Tabs, message } from "antd";
    ...
    <>
      ...
      <Card>
        <Tabs defaultActiveKey="1">
          <Tabs.TabPane tab="Nội dung" key="1">
